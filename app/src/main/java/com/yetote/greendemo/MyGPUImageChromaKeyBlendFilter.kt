 ...
 */
class MyGPUImageChromaKeyBlendFilter : GPUImageTwoInputFilter(CHROMA_KEY_BLEND_FRAGMENT_SHADER) {
    private var thresholdSensitivityLocation = 0
    private var smoothingLocation = 0
    private var colorToReplaceLocation = 0
    ...
    companion object {
        const val CHROMA_KEY_BLEND_FRAGMENT_SHADER = " precision highp float;\n" +
                " \n" +
